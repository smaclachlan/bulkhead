...
- `WORKSPACE_RUNTIME`, `WORKSPACE_DOCKERFILE_DIR`, `WORKSPACE_REPO_PATH`, `WORKSPACE_HOST_PATH`, `WORKSPACE_USER` - see [Custom workspace image](#custom-workspace-image) and [Kata Containers setup](#kata-containers-setup-phase-2-workspace-container).
